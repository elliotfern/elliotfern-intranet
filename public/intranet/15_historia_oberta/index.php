<main>
    <div class="container">
        <h2><a href="/gestio/vault">Historia Oberta</a> > <a href="/vault">Elliot</a></h2>
...
<script>
    ...
    function displayArticles(articles) {
        ...
        articles.forEach(article => {
            ...
            modifyCell.innerHTML = `<a href="/gestio/historia-oberta/modifica-article/${article.ID}"><button type="button" class="btn-primari btn-petit">Modifica</button></a>`;
