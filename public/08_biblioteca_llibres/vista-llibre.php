...
function fetchApiData(url) {
  ...
  .then(data => {
    ...
    try {
      ...
      document.getElementById('nameImg').src = `${window.location.origin}/public/00_inc/img/08_biblioteca_llibres/llibres/${data.nameImg}.jpg`;
...
fetchApiData("/api/biblioteca/get/?type=llibreSlug&slug=<?php echo $slug; ?>");
</script>
