...
// some action goes here under php
    ...
    echo '<form method="POST" action="" id="modalFormAddSupplyInvoice" class="row g-3" >';
    ...
    echo '<div class="col-md-4">';
    echo '<label>Customer associate:</label>';
    echo '<select class="form-select" name="clientVinculat" id="clientVinculat">';
    echo '<option selected value="">Select an option:</option>';
    $stmt = $conn->prepare("SELECT c.id, c.clientEmpresa
