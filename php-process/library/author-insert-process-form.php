...
function data_input($data) {
  ...
  if (!isset($hasError)) {
    global $conn;
    $sql = "INSERT INTO db_library_authors SET AutNom=:AutNom, AutCognom1=:AutCognom1, yearBorn=:yearBorn, yearDie=:yearDie, paisAutor=:paisAutor, img=:img, AutWikipedia=:AutWikipedia, AutDescrip=:AutDescrip, AutMoviment=:AutMoviment, AutOcupacio=:AutOcupacio, dateModified=:dateModified, dateCreated=:dateCreated";
