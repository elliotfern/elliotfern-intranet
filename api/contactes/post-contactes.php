...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
  ...
  if (isset($headers['Authorization'])) {
      ...
      if (verificarToken($token)) {
        ...
        if (!isset($hasError)) {
          global $conn;
          $sql = "INSERT INTO db_contactes SET nom=:nom, cognoms=:cognoms, email=:email, tel_1=:tel_1, tel_2=:tel_2, tel_3=:tel_3, adreca=:adreca, data_naixement=:data_naixement, web=:web, tipus=:tipus, pais=:pais";
