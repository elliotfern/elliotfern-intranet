...
echo "<p class='text-right'><a href='/gestio/comptabilitat/facturacio-clients' class='btn btn-info btn-sm' role='button' aria-pressed='true'>Customers invoices &rarr;</a>
