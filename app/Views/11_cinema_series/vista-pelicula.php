...
<div class='row'>
  ...
  <div class="col-sm-4">
    <p><a href="/cinema/pelicules/modifica/<?php echo $id; ?>" class="btn btn-warning btn-sm modificar-link">Modifica les dades</a>
    <p>
...
<script>
  connexioApiGetDades("/api/cinema/get/?pelicula=", <?php echo $id; ?>, "img", "cinema-movie", function(data) {
