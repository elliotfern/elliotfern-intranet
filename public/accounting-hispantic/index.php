...
echo '<h1>Hispano Atlantic Consulting Ltd</h1>';
...
echo "<p class='text-right'><a href='costumers.php' class='btn btn-info btn-sm' role='button' aria-pressed='true'>Customers list &rarr;</a>
...
FROM db_accounting_hispantic_invoices_customers AS f
...
echo "<p class='text-right'><a href='erp-invoices-customers.php' class='btn btn-info btn-sm' role='button' aria-pressed='true'>Customers invoices &rarr;</a>
...
FROM db_accounting_hispantic_invoices_suppliers AS i
...
echo "<p><a href='erp-invoices-supplies.php' class='btn btn-info btn-sm' role='button' aria-pressed='true'>Invoices Supplies &rarr;</a>
...
FROM db_accounting_hispantic_invoices_suppliers AS fp
...
FROM db_accounting_hispantic_invoices_suppliers AS factures
